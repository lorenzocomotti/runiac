...
RUN apt -y install wget git jq && apt -y --fix-missing install unzip && apt -y --fix-missing install python-pip && apt -y --fix-missing install git && apt -y --fix-missing install apt-transport-https 
